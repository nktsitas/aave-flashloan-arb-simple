...
FlashLoanAave=0x1f914724822F1dD9BAeCc493E8f1Af4F466bb472
...
# forge create --rpc-url $SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --gas-price 15000000000 FlashLoanAave --constructor-args 0x012bAC54348C0E635dCAc9D5FB99f06F24136C9A --via-ir
# forge create --rpc-url $MAINNET_RPC_URL --private-key $PRIVATE_KEY --gas-price 15000000000 FlashLoanAave --constructor-args 0x2f39d218133AFaB8F2B819B1066c7E434Ad94E9e --via-ir
